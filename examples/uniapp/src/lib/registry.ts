import { h } from "vue";
import type { Components } from "@json-render/uniapp";
import { useBoundProp } from "@json-render/uniapp";
import type { AppCatalog } from "./catalog";

// H5 platform: use standard HTML elements.
// For mini program targets, replace div/span/button/input with
// UniApp native components: view/text/button/input.
