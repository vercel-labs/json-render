...
export const demoSpec: Spec = {
  ...
  state: {
    ...
    name: "",
    todos: [
      { id: 1, title: "Learn UniApp", completed: true },
      { id: 2, title: "Try @json-render/uniapp", completed: false },
      { id: 3, title: "Build a mini program", completed: false },
    ],
  },
  elements: {
    root: {
    ...
    header: {
      type: "Text",
      props: {
        content: "@json-render/uniapp demo",
        size: "xl",
        weight: "bold",
      },
    },
    ...
    "counter-card": {
      ...
      props: {
        title: "Counter",
        subtitle: "Tap the buttons to change the count",
      },
    ...
    "todo-item": {
      ...
      on: {
        tap: { action: "toggleItem", params: { index: { $index: true } } },
      },
    },
